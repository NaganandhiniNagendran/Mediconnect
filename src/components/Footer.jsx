      ...
      <div className="section-container">
        <div className="footer-grid">
          <div className="footer-about">
            ...
            <p className="footer-about-text">Making healthcare accessible to everyone, everywhere.</p>
          </div>
        ...
        <div className="footer-divider">
          <div className="footer-bottom">
            <p className="footer-copyright">&copy; 2024 MediConnect. All rights reserved.</p>
